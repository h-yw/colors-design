export const languages = {
  ...
  export const ui = {
    zh: {
      ...
      'harmony.title': '色彩和声 (Harmony)',
      'harmony.desc': '基于 OKLCH 色环的数学和谐关系。',
      'harmony.based_on': '基于当前主色',
      'harmony.complementary': '互补色 (Complementary)',
      'harmony.analogous': '邻近色 (Analogous)',
      'harmony.triadic': '三色 (Triadic)',
      'harmony.apply_secondary': '设为辅助色',
      'harmony.apply_tertiary': '设为强调色',
      'nav.harmony': '🎨 色彩和声',
    },
    en: {
      'hero.badge': 'Designed for Engineering',
      ...
      'harmony.desc': 'Mathematical harmonies based on the OKLCH color wheel.',
      'harmony.based_on': 'Based on Brand Color',
      'harmony.complementary': 'Complementary',
      'harmony.analogous': 'Analogous',
      'harmony.triadic': 'Triadic',
      'harmony.apply_secondary': 'Set as Secondary',
      'harmony.apply_tertiary': 'Set as Tertiary',
      'nav.harmony': '🎨 Harmony',
    },
  } as const;
